# @rootui/typography
[![Github repository](https://img.shields.io/badge/github-repo-blue?logo=github)](https://github.com/rootui-org/root-ui) [![Npm monthly downloads](https://img.shields.io/npm/dm/@rootui/typography)](https://www.npmjs.com/package/@rootui/typography) [![Npm monthly downloads](https://img.shields.io/badge/live-demo-green)](https://root-ui.com/primitives/typography) [![Root UI X profile](https://img.shields.io/twitter/follow/rootui_)](https://x.com/rootui_)

Use typography to present your design and content as clearly and efficiently as possible.

 - 📖 Docs: [Root UI typography docs](https://root-ui.com/primitives/typography)
 - 📄 Source: [Github repository](https://github.com/rootui-org/root-ui)
 - 🐛 Report an issue: [Open an issue](#)
 - 📦 Package: [@rootui/typography](https://www.npmjs.com/package/@rootui/typography)
...
# or
yarn add @rootui/typography
# or
pnpm add @rootui/typography
# or
...
## 💻 Usage
```tsx
import { Typography } from "@rootui/typography";
...
```
## 📃 API Reference
Check the [Root UI typography docs](https://root-ui.com/docs/primitives/typography#api-reference).
