# @rootui/slider
[![Github repository](https://img.shields.io/badge/github-repo-blue?logo=github)](https://github.com/rootui-org/root-ui) [![Npm monthly downloads](https://img.shields.io/npm/dm/@rootui/slider)](https://www.npmjs.com/package/@rootui/slider) [![Npm monthly downloads](https://img.shields.io/badge/live-demo-green)](https://root-ui.com/primitives/slider) [![Root UI X profile](https://img.shields.io/twitter/follow/rootui_)](https://x.com/rootui_)


A slider allows a user to select one or more values within a range.

 - 📖 Docs: [Root UI slider docs](https://root-ui.com/primitives/slider)
 - 📄 Source: [Github repository](https://github.com/rootui-org/root-ui)
 - 🐛 Report an issue: [Open an issue](#)
 - 📦 Package: [@rootui/slider](https://www.npmjs.com/package/@rootui/slider)
 - 🔗 Reference: [React Aria docs](https://react-aria.adobe.com/Slider)
...
# or
yarn add @rootui/slider
# or
pnpm add @rootui/slider
# or
...
## 💻 Usage
```tsx
import { slider } from "@rootui/slider";
...
```
## 📃 API Reference
Check the [Root UI slider docs](https://root-ui.com/docs/primitives/slider#api-reference).
