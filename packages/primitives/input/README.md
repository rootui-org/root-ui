...
[![Github repository](https://img.shields.io/badge/github-repo-blue?logo=github)](https://github.com/rootui-org/root-ui) [![Npm monthly downloads](https://img.shields.io/npm/dm/@rootui/input)](https://www.npmjs.com/package/@rootui/input) [![Npm monthly downloads](https://img.shields.io/badge/live-demo-green)](https://root-ui.com/primitives/input) [![Root UI X profile](https://img.shields.io/twitter/follow/rootui_)](https://x.com/rootui_)
...
Input is a primitive single-line text input component that accepts standard HTML attributes and let users enter and edit text.
 ...
 - 📖 Docs: [Root UI input docs](https://root-ui.com/primitives/input)
 - 📄 Source: [Github repository](https://github.com/rootui-org/root-ui)
 - 🐛 Report an issue: [Open an issue](#)
 - 📦 Package: [@rootui/input](https://www.npmjs.com/package/@rootui/input)
 - 🔗 Reference: [React Aria docs](https://react-aria.adobe.com/TextField)
...
# or
yarn add @rootui/input
# or
pnpm add @rootui/input
# or
...
## 💻 Usage
```tsx
import { Input } from "@rootui/input";
...
```
## 📃 API Reference
Check the [Root UI input docs](https://root-ui.com/docs/primitives/input#api-reference).
